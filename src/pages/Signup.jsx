        ...
        <div className="min-h-screen bg-earth-50 flex items-center justify-center p-4 font-sans">
            ...
            <div className="card-premium w-full max-w-md">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-display font-bold text-earth-900">Create Account</h2>
                    <p className="text-earth-600 mt-2">Start your journey to success</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-earth-700 mb-2">Password</label>
                        <div className="relative">
                        ...
                        <p className="mt-2 text-xs text-earth-500 font-medium pl-1">Must be at least 6 characters</p>
                    </div>
                ...
                <div className="mt-8 text-center text-earth-600 font-medium">
                    ...
                    <Link to="/login" className="text-earth-800 font-bold hover:underline">
                        Login
                    </Link>
                </div>
            </div>
